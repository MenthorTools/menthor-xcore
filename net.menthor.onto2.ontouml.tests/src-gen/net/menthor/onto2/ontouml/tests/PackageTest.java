 ...
 * @generated
 */
public class PackageTest extends ContainerTest {
	 ...
	 */
	@Override
	protected net.menthor.onto2.ontouml.Package getFixture() {
		return (net.menthor.onto2.ontouml.Package)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(OntoumlFactory.eINSTANCE.createPackage());
	}
