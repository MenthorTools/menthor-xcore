...
import net.menthor.metamodel.ontouml.*;
import net.menthor.metamodel.ontouml.Class;
import net.menthor.metamodel.ontouml.Package;
...
public class OntoumlPrintHelper {
	...
	{		
		...
		{	
		    ...
		    Classifier general = genset.getSpecializedClassifier();		    
		    result += getStereotypeAndName(elem, false, false) + " / "+getName(general)+" { ";		   	    
		    int i=1;
		    for(Classifier specific: genset.getSpecializingClassifier())
		    {
		    	if(i < genset.getSpecializingClassifier().size()) 
