...
public class OntoumlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case OntoumlPackage.PACKAGE: {
				net.menthor.onto2.ontouml.Package package_ = (net.menthor.onto2.ontouml.Package)theEObject;
			...
			case OntoumlPackage.CLASS: {
				net.menthor.onto2.ontouml.Class class_ = (net.menthor.onto2.ontouml.Class)theEObject;
			...
			case OntoumlPackage.GENERALIZATION: {
				...
				if (result == null) result = caseContainedElement(generalization);
	 ...
	 * @generated
	 */
	public T casePackage(net.menthor.onto2.ontouml.Package object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseClass(net.menthor.onto2.ontouml.Class object) {
		return null;
	}
