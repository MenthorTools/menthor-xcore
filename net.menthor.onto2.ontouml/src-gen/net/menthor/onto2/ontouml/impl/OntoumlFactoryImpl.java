...
public class OntoumlFactoryImpl extends EFactoryImpl implements OntoumlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case OntoumlPackage.CONSTRAINT: return createConstraint();
	 ...
	 * @generated
	 */
	public net.menthor.onto2.ontouml.Package createPackage() {
	 ...
	 * @generated
	 */
	public net.menthor.onto2.ontouml.Class createClass() {
