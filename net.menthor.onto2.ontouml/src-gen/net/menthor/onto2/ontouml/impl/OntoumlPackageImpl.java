...
import net.menthor.onto2.ontouml.util.OntoumlValidator;
...
public class OntoumlPackageImpl extends EPackageImpl implements OntoumlPackage {
	 ...
	 * @see net.menthor.onto2.ontouml.OntoumlPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
			...
			(theOntoumlPackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return OntoumlValidator.INSTANCE;
				 }
			 });
	 ...
	 * @generated
	 */
	public EOperation getModel__InitializeValidator__DiagnosticChain_Map() {
	 ...
	 * @generated
	 */
	public EOperation getDataType__IsStructure() {
		return dataTypeEClass.getEOperations().get(22);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(modelEClass, MODEL___INITIALIZE_VALIDATOR__DIAGNOSTICCHAIN_MAP);
		...
		createEReference(classifierEClass, CLASSIFIER__IS_GENERAL_IN);
		createEReference(classifierEClass, CLASSIFIER__IS_SPECIFIC_IN);
		...
		createEOperation(dataTypeEClass, DATA_TYPE___IS_STRUCTURE);
	...
	public void initializePackageContents() {
		...
		generalizationEClass.getESuperTypes().add(this.getContainedElement());
		...
		initEClass(containerEClass, net.menthor.onto2.ontouml.Container.class, "Container", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContainer_Elements(), this.getContainedElement(), this.getContainedElement_Holder(), "elements", null, 0, -1, net.menthor.onto2.ontouml.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		op = initEOperation(getModel__InitializeValidator__DiagnosticChain_Map(), theEcorePackage.getEBoolean(), "initializeValidator", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getClassifier_IsGeneralIn(), this.getGeneralization(), this.getGeneralization_General(), "isGeneralIn", null, 0, -1, Classifier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClassifier_IsSpecificIn(), this.getGeneralization(), this.getGeneralization_Specific(), "isSpecificIn", null, 0, -1, Classifier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEOperation(getDataType__IsStructure(), theEcorePackage.getEBoolean(), "isStructure", 0, 1, !IS_UNIQUE, IS_ORDERED);

		initEClass(classEClass, net.menthor.onto2.ontouml.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getClass_Stereotype(), this.getClassStereotype(), "stereotype", null, 0, 1, net.menthor.onto2.ontouml.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClass_IsAbstract(), theEcorePackage.getEBoolean(), "isAbstract", null, 0, 1, net.menthor.onto2.ontouml.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClass_IsDerived(), theEcorePackage.getEBoolean(), "isDerived", null, 0, 1, net.menthor.onto2.ontouml.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClass_IsExtensional(), theEcorePackage.getEBoolean(), "isExtensional", null, 0, 1, net.menthor.onto2.ontouml.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClass_QualityNature(), this.getQualityNature(), "qualityNature", null, 0, 1, net.menthor.onto2.ontouml.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClass_Existence(), this.getExistence(), "existence", null, 0, 1, net.menthor.onto2.ontouml.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClass_Classification(), this.getClassification(), "classification", null, 0, 1, net.menthor.onto2.ontouml.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGeneralization_Specific(), this.getClassifier(), this.getClassifier_IsSpecificIn(), "specific", null, 1, 1, Generalization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGeneralization_GeneralizationSet(), this.getGeneralizationSet(), this.getGeneralizationSet_Generalizations(), "generalizationSet", null, 0, 1, Generalization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
