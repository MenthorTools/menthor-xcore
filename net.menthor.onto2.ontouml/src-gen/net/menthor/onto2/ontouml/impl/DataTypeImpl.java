 ...
 *   <li>{@link net.menthor.onto2.ontouml.impl.DataTypeImpl#getScale <em>Scale</em>}</li>
 *   <li>{@link net.menthor.onto2.ontouml.impl.DataTypeImpl#getMeasurement <em>Measurement</em>}</li>
 *   <li>{@link net.menthor.onto2.ontouml.impl.DataTypeImpl#getUnitOfMeasure <em>Unit Of Measure</em>}</li>
 *   <li>{@link net.menthor.onto2.ontouml.impl.DataTypeImpl#getLowerBoundRegion <em>Lower Bound Region</em>}</li>
 *   <li>{@link net.menthor.onto2.ontouml.impl.DataTypeImpl#getUpperBoundRegion <em>Upper Bound Region</em>}</li>
 *   <li>{@link net.menthor.onto2.ontouml.impl.DataTypeImpl#getOwnerDomain <em>Owner Domain</em>}</li>
