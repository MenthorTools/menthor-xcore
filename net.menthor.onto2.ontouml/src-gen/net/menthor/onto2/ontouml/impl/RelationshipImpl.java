 ...
 *   <li>{@link net.menthor.onto2.ontouml.impl.RelationshipImpl#getSymmetry <em>Symmetry</em>}</li>
 *   <li>{@link net.menthor.onto2.ontouml.impl.RelationshipImpl#getTransitivity <em>Transitivity</em>}</li>
 *   <li>{@link net.menthor.onto2.ontouml.impl.RelationshipImpl#getCiclicity <em>Ciclicity</em>}</li>
 *   <li>{@link net.menthor.onto2.ontouml.impl.RelationshipImpl#getEndPoints <em>End Points</em>}</li>
...
public class RelationshipImpl extends ClassifierImpl implements Relationship {
	 ...
	 * @generated
	 */
	public net.menthor.onto2.ontouml.Class sourceClass() {
	 ...
	 * @generated
	 */
	public net.menthor.onto2.ontouml.Class targetClass() {
