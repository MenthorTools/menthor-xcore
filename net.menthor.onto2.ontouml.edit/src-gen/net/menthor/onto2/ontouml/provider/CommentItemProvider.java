...
/**
 * This is the item provider adapter for a {@link net.menthor.onto2.ontouml.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OntoumlPackage.Literals.COMMENT__CONTENT,
				 true,
				 false,
				 false,
	...
	protected void addOwnerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Comment_owner_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Comment_owner_feature", "_UI_Comment_type"),
				 OntoumlPackage.Literals.COMMENT__OWNER,
				 true,
				 false,
				 true,
				 null,
