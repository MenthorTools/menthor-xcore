...
/**
 * This is the item provider adapter for a {@link net.menthor.onto2.ontouml.Container} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContainerItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OntoumlPackage.Literals.CONTAINER__ELEMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OntoumlPackage.Literals.CONTAINER__ELEMENTS,
				 OntoumlFactory.eINSTANCE.createPackage()));

		newChildDescriptors.add
			(createChildParameter
				(OntoumlPackage.Literals.CONTAINER__ELEMENTS,
				 OntoumlFactory.eINSTANCE.createConstraint()));
